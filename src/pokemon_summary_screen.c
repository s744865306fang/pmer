...
const u8 sText_TitleContestMoves[] = _("技能");
const u8 sText_TitleRibbons[] = _("缎带");
const u8 sText_TitleIVs[] = _("个体值");
const u8 sText_TitleEVs[] = _("努力值");
const u8 sText_TitlePage[] = _("{DPAD_LEFTRIGHT}翻页");
const u8 sText_TitlePageDetail[] = _("{DPAD_LEFTRIGHT}翻页 {A_BUTTON}详情");
const u8 sText_TitlePickSwitch[] = _("{DPAD_UPDOWN}选择 {A_BUTTON}移动");
const u8 sText_TitlePageIVs[] = _("{DPAD_LEFTRIGHT}翻页 {A_BUTTON}IVs");
const u8 sText_TitlePageEVs[] = _("{DPAD_LEFTRIGHT}翻页 {A_BUTTON}EVs");
...
const u8 sText_None[] = _("无");
const u8 sText_Cancel[] = _("取消");
const u8 sText_Power[] = _("威力");
const u8 sText_Accuracy[] = _("命中率");
const u8 sText_Appeal[] = _("吸引力");
const u8 sText_Jam[] = _("干扰力");
const u8 sText_DexNo[] = _("图鉴编号");
const u8 sText_Species[] = _("名字");
const u8 sText_Type[] = _("属性");
const u8 sText_ExpPoints[] = _("经验值");
const u8 sText_ToNextLevel[] = _("距下一等级");
const u8 sText_Attack[] = _("攻击");
const u8 sText_Defense[] = _("防御");
const u8 sText_SpecialAttack[] = _("特攻");
const u8 sText_SpecialDefense[] = _("特防");
const u8 sText_Speed[] = _("速度");
const u8 sText_Ability[] = _("特性");
...
const u8 sText_HeldItem[] = _("携带道具");
#else
const u8 sText_None[] = _("无");
const u8 sText_Cancel[] = _("取消");
const u8 sText_Power[] = _("威力");
...
{
    u32 pp, color=PSS_COLOR_BLACK_GRAY_SHADOW, x;
    struct PokeSummary *summary = &sMonSummaryScreen->summary;
    struct Pokemon *mon = &sMonSummaryScreen->currentMon;
...
static void PrintMoveDetails(u16 move)
{
    ...
    if (move != MOVE_NONE)
    {
        if (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES)
        {
            ...
            PrintTextOnWindow(PSS_LABEL_PANE_LEFT_MOVE, gMovesInfo[move - 1].description, 2, 64, 0, 0);
